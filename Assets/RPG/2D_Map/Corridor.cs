...
public class Corridor
{
    ...
    public bool SetupCorridor(Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor , Room[] rooms, int room_num)
    {
        // Set a random direction (a random index from 0 to 3, cast to Direction).
        direction = (Direction)Random.Range(0, 4);
        ...
        Rect a, b;
        a = new Rect(startXPos, startYPos - corridorLength, 1, corridorLength);
        switch (direction)
        {
            case Direction.North:
                a = new Rect(startXPos, startYPos - corridorLength, 1, corridorLength);
                break;
            case Direction.East:
                a = new Rect(startXPos - corridorLength, startYPos, corridorLength, 1);
                break;
            case Direction.South:
                a = new Rect(startXPos, startYPos, 1, corridorLength);
                break;
            case Direction.West:
                a = new Rect(startXPos, startYPos, corridorLength, 1);
                break;
        }
